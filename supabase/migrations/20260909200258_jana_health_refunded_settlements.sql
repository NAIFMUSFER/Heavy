-- A settled order may have a valid partial or full refund. Preserve all amount checks.
...
begin
  ...
  select count(*) into bad_cash from public.orders where (cash_state='settled' and payment_state NOT IN ('collected','partially_refunded','refunded')) or refunded_halalas > collected_halalas;
