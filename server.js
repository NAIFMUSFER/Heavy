...
const PUBLIC_FILES = ['index.html','admin.html','picker.html','courier.html','offline.html','manifest.webmanifest','sw.js','assets/icon.svg','assets/common.js','assets/zone-map.js','assets/address.js','assets/order.js','assets/checkout.js'];
...
function routeLabel(p){return p.replace(/^(\/api\/ops\/customer-returns)\/[^/]+\/(inspection|dispositions)$/,'$1/:id/$2').replace(/(\/orders|\/quotes|\/addresses|\/coverage|\/tickets|\/substitutions|\/notifications|\/lots|\/families|\/offerings|\/coupons|\/slots|\/zones|\/favorites|\/refunds|\/product-versions|\/support|\/customers|\/staff|\/stock|\/suppliers|\/counts|\/count-lines|\/shopping-lists|\/recurring)\/[^/]+/g,'$1/:id')}
