...
function routeLabel(p){return p.replace(/^(\/api\/ops\/customer-returns)\/[^/]+\/(inspection|dispositions)$/,'$1/:id/$2').replace(/(\/orders|\/quotes|\/addresses|\/coverage|\/tickets|\/substitutions|\/notifications|\/lots|\/families|\/offerings|\/coupons|\/slots|\/zones|\/favorites|\/refunds|\/product-versions|\/support|\/customers|\/staff|\/stock|\/suppliers|\/counts|\/count-lines|\/disposals|\/bins|\/shopping-lists|\/recurring)\/[^/]+/g,'$1/:id')}
