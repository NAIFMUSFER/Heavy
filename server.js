...
function routeLabel(p){return p.replace(/(\/orders|\/quotes|\/addresses|\/coverage|\/tickets|\/substitutions|\/notifications|\/lots|\/families|\/offerings|\/coupons|\/slots|\/zones|\/favorites|\/refunds|\/product-versions|\/support|\/staff|\/stock|\/suppliers|\/counts|\/count-lines|\/shopping-lists|\/recurring)\/[^/]+/g,'$1/:id')}
