...
const VERSION='jana-static-v11';
const SHELL=['/offline.html','/assets/styles.css','/assets/common.js','/assets/catalog-import.js','/assets/address.js','/assets/order.js','/assets/checkout.js','/assets/local-cart.js','/assets/input.js','/assets/zone-map.js','/assets/shop.js','/assets/ops.js','/assets/icon.svg'];
