...
const VERSION='jana-static-v5';
const SHELL=['/offline.html','/assets/styles.css','/assets/common.js','/assets/zone-map.js','/assets/shop.js','/assets/ops.js','/assets/icon.svg'];
