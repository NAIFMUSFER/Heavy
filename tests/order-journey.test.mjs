...
test('customer timeline maps recorded public events and ignores internal entries without inventing timestamps',()=>{
 const f=orderFacts({timeline:[{id:'1',event:'supplier_pickup_order_created',created_at:1799999999999},{id:'2',event:'order_created',created_at:1800000000000},{id:'3',event:'start_picking',created_at:1800000000001},{id:'4',event:'line_removal_proposed',created_at:1800000000002},{id:'5',event:'line_removal_accepted',created_at:1800000000003},{id:'6',event:'component_substitution_proposed',created_at:1800000000004},{id:'7',event:'component_substitution_accepted',created_at:1800000000005},{id:'8',event:'cash_settled',created_at:1800000000006},{id:'9',event:'delivered',created_at:null}]});
 assert.deepEqual(f.timeline.map(x=>x.title),['تم تأكيد الطلب','تم تأكيد الطلب','بدأ تجهيز الطلب','طُلبت موافقتك على حذف صنف','وافقت على حذف الصنف','طُلبت موافقتك على مكوّن بديل للسلة','وافقت على مكوّن السلة البديل']);
});
