...
const cases=[
 ['GET','/disposals'],['GET','/lots/fixture/disposal'],['POST','/lots/fixture/disposal',{kind:'waste',quantity_base:1,revision:0,reason:'Fixture disposal',reference:'Fixture document'}],
