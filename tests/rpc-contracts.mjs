...
const journeyCases=[['POST','/api/ops/orders/fixture/location',{latitude:16.5,longitude:42.5,accuracy_m:15}],['GET','/api/orders?limit=25&before_at=1800000000000&before_id=fixture'],['GET','/api/orders/fixture/tracking'],['POST','/api/auth/password',{current_password:'fixture-current-password',new_password:'fixture-new-password'}]];
