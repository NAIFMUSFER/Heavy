...
const staffCases=[['GET','/api/ops/staff'],['GET','/api/ops/audit'],['POST','/api/ops/staff',{email:'fixture@example.invalid',name:'Fixture staff',password:'Fixture-only-password',role:'inventory'}],['PATCH','/api/ops/staff/fixture',{active:false,reason:'Fixture change'}],['POST','/api/ops/orders/fixture/assignment',{picker_id:'fixture-picker',reason:'Fixture assignment'}]];
...
const savedCases=[['GET','/api/shopping-lists'],['POST','/api/shopping-lists',{name:'Fixture list',items:[]}],['PATCH','/api/shopping-lists/fixture',{revision:1,name:'Renamed'}],['DELETE','/api/shopping-lists/fixture',{revision:1}],['GET','/api/recurring'],['POST','/api/recurring',{name:'Fixture plan',cadence:'weekly',items:[],next_at:4102444800000}],['PATCH','/api/recurring/fixture',{revision:1,state:'paused'}],['GET','/api/profile'],['PATCH','/api/profile',{name:'Fixture customer'}]];
