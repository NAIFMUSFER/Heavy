...
const cases=[
 ...
 ['POST','/products',{title:'Fixture product',offerings:[]}],['POST','/products/import',{schema_version:1,products:[]}],['POST','/product-versions/11111111-1111-1111-1111-111111111111/activate'],
