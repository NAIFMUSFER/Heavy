...
Ordering and offset tradeoffs follow the [PostgreSQL documentation](https://www.postgresql.org/docs/17/queries-limit.html). The migration remains unapplied pending database and browser validation.
