...
Latest verified web release: **219469f32c240c618bdbbcc751f36cdd5c9af609**, LIVE **11 September 2026 at 13:40:55 UTC** via Render **dep-dai09eajnfac73adgm00**. Exact-commit [verification and public smoke](https://github.com/NAIFMUSFER/Heavy/actions/runs/34604839540) passed **316 Node tests** and **27 production checks**; the [disposable browser journey](https://github.com/NAIFMUSFER/Heavy/actions/runs/34604839566) passed **78 checks**. The owner launch center now downloads a privacy-minimized readiness observation without sending data or changing commerce. Supabase is unchanged at **90 migrations**, with ACTIVE **jana-api v32**, jana-critical v6 and jana-ops-extra v23; custom-session authentication and intentional `verify_jwt:false` are unchanged. The earlier cart synchronization and atomic inactive-draft catalog import remain available. No database, Edge, provider, mobile source, commercial data or admission setting changed in this web-only release. Older dated checkpoints below retain historical states.
