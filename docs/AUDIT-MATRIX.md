...
| Edge | 35 local transport tests pass | CSRF, JSON/body limits, password errors, quote idempotency, Origin enforcement | Origin patch v8/v3/v6 active; critical dispatcher Edge integration pending | Deploy 3 functions and verify versions |
