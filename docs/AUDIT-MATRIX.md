...
| Picker/substitutions | Assignment, FEFO, weight tolerance, fixed-basket measurements, explicit customer-approved replacements and whole-line removal with lower total | Component-level basket substitution/variance/tolerance/pricing rules and field acceptance |
