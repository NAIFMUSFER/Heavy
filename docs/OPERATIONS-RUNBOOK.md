...
**Resolved 2026-09-11:** after the owner reported payment, the service returned `suspended: not_suspended` and an empty `suspenders` list (service updated at 02:57:28 UTC). Fresh source/CI/backend checks preceded promotion of 07125e5. No automatic deployment appeared after promotion; the existing public-clone path required one manual deploy, dep-dahmvfid0e5s7382utpg, which became live at 03:05:05 UTC. Exact-commit public smoke 34556999274 passed at 03:05:20 UTC. No plan change, new charge, migration or Edge redeployment was performed. Future incidents still require fresh service and public-health evidence; an owner payment report or a historical deployment label alone is not a successful release check.
